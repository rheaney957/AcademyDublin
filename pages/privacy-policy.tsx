        ...
        <div className={styles.container}>
            ...
            <main className={styles.main}>
                <div className={styles.privacyPolicyContainer}>
                    ...
                    <p>This privacy policy sets out the ways in which The Academy (Shine.net) may use your personal data. The Academy is a company registered in Northern Ireland (IE447216).</p>

                    <div>In this Privacy Policy,
                        <ul>
                            <li>'we', 'us' or 'our' means The Academy</li>
                    ...
                    <p>The Academy may use your information for the following purposes:</p>
                    <ul>
                        <li>
                    ...
                    <p>The Academy has the discretion to update this privacy policy at any time. When we do, we will revise the updated date at the bottom of this page. We encourage you to frequently check this page for any changes to stay informed about how we are helping to protect the personal information we collect. You acknowledge and agree that it is your responsibility to review this privacy policy periodically and become aware of modifications.</p>
